...
int main(){ios::sync_with_stdio(false);cin.tie(nullptr);long long a,b;cin>>a>>b;cout<<a+b<<"\n";return 0;}
```
...
int main(){ios::sync_with_stdio(false);cin.tie(nullptr);int n;cin>>n;for(int i=1;i<=n;i++){for(int j=1;j<=n;j++)cout<<setw(3)<<(i-1)*n+j;cout<<"\n";}return 0;}
```
...
int main(){ios::sync_with_stdio(false);cin.tie(nullptr);int n;cin>>n;vector<int>a(n+1);for(int i=1;i<=n;i++)cin>>a[i];sort(a.begin()+1,a.end());for(int i=1;i<=n;i++){if(i>1)cout<<" ";cout<<a[i];}cout<<"\n";return 0;}
```
...
int main(){ios::sync_with_stdio(false);cin.tie(nullptr);string s;cin>>s;string t=s;reverse(t.begin(),t.end());cout<<(s==t?"YES":"NO")<<"\n";return 0;}
```
